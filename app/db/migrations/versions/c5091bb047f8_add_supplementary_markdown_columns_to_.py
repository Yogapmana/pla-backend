"""Add supplementary markdown columns to learning_modules

Revision ID: c5091bb047f8
Revises: 7f26b5c6298a
Create Date: 2026-07-20 11:48:26.264830
...
revision: str = 'c5091bb047f8'
down_revision: Union[str, Sequence[str], None] = '7f26b5c6298a'
...
def upgrade() -> None:
    ...
    op.add_column('learning_modules', sa.Column('remedial_markdown', sa.String(), nullable=True))
    op.add_column('learning_modules', sa.Column('deep_dive_markdown', sa.String(), nullable=True))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('learning_modules', 'deep_dive_markdown')
    op.drop_column('learning_modules', 'remedial_markdown')
